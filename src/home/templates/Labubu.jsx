...
const products = [
  { id: 7, name: 'Labubu Ver1', description: 'A cute and cuddly doll, perfect for all ages.', price: '120.000đ', image: Labubu1 },
  { id: 8, name: 'Labubu Ver2', description: 'A friendly doll with a charming smile.', price: '150.000đ', image: Labubu2 },
  { id: 9, name: 'Labubu Ver3', description: 'A playful doll that brings endless fun.', price: '130.000đ', image: Labubu3 },
      ...
      <section className="products-grid-container">
        <div className="products-grid">
          {products.map((product) => (
            <Link to={`/dolls/${product.id}`} key={product.id} className="doll-product-card">
